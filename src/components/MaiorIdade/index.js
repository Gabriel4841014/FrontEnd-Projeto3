                    ...
                    <div className="w-[90%] max-w-[800px] h-auto bg-[#EAE5E1] p-6 md:p-10 rounded-lg text-center">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 justify-center">
                            <button
                                ...
                                className="w-full md:w-50 h-10 p-1 bg-[#20232A] text-white rounded-[10px]"> Eu tenho 18 anos ou mais.
                            </button>

                            <button
                                onClick={() => handleResponse(false)}
                                className="w-full md:w-50 h-10 p-2 bg-[#20232A] text-white rounded-[10px]"> Eu sou menor de 18 anos.
                            </button>
                        </div>
