...
export default function Vitrine() {
    ...
    return (
        ...
        <div className="w-full h-auto px-4 sm:px-8 lg:px-16 py-10 bg-[#000002] flex flex-row items-center justify-center gap-5 flex-2/5">
           
            <div className="w-[230px] h-[620] flex mt-10 mb-auto flex-col bg-[#20232A] pb-10">
