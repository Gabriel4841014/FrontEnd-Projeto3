  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center p-4 ">
        ...
        <h1 class="text-center md:text-3xl mb-8 text-[#E1D5C2] mt-25">Descubra os vinhos mais especiais da nossa seleção!</h1>
        ...
        <div class="grid gap-8 w-2/4 mt-15">
          <div class="bg-[#20232A] rounded-lg overflow-hidden flex flex-col md:flex-row mb-5">
            ...
            <div class="p-6 md:p-8 flex flex-col justify-center ml-5">
              ...
              <p class="mb-4">Intensos, encorpados e repletos de aromas marcantes, os vinhos tintos brasileiros são perfeitos para quem aprecia sabor e tradição.</p>
              <p class="mb-4 text-[#E1D5C2]">Ideias para harmonizar com:</p>
              <ul class="list-disc list-inside mb-4">
                <li>Carnes</li>
                <li>Queijos curados</li>
                <li>Momentos especiais</li>
              </ul>
              <button class="bg-[#3F0D09] text-white py-1 px-4 rounded-md w-45">Compre conosco</button>
            </div>
          </div>
          ...
          <div class="bg-[#20232A] rounded-lg overflow-hidden flex flex-col md:flex-row-reverse mb-5">
            ...
            <div class="p-6 md:p-8 flex flex-col justify-center ml-5">
              ...
              <h2 class="text-[16px] mb-2 text-[#E1D5C2]">Conheça Nossos:</h2>
              <h3 class="text-2xl md:text-3xl">Vinhos Brancos</h3>
              <hr className="w-40 ml-8 mt-4 mb-4 text-[#E1D5C2]" />
              <p class="mb-4">Leves, refrescantes e aromáticos, os vinhos brancos brasileiros são perfeitos para quem busca frescor em cada gole.</p>
              <p class="mb-4 text-[#E1D5C2]">Ideias para harmonizar com:</p>
              ...
              <button class="bg-[#3F0D09] text-white py-2 px-4 rounded-md w-45">Compre conosco</button>
            </div>
          </div>
          ...
          <div class="bg-[#20232A] rounded-lg overflow-hidden flex flex-col md:flex-row">
            ...
            <div class="p-6 md:p-8 flex flex-col justify-center ml-5">
              <h2 class="text-[16px] mb-2 text-[#E1D5C2]">Conheça Nossos:</h2>
              <h3 class="text-2xl md:text-3xl mb-4">Vinhos Rosés</h3>
              <hr className="w-32 ml-8 mt-0 mb-4 text-[#E1D5C2]" />
              <p class="mb-4">Leves e vibrantes, os vinhos rosés oferecem um equilíbrio perfeito entre a frescura dos brancos e a intensidade dos tintos.</p>
              <p class="mb-4 text-[#E1D5C2]">Ideias para harmonizar com:</p>
