...
export default function EntrarLogin() {
    ...
    const handleGoogleSuccess = async (credentialResponse) => {
        try {
            ...
            if (response.ok) {
                ...
                setErrorMessage(data.message || "Falha no login com Google");
            }
        } catch (error) {
    ...
    const handleGoogleError = () => {
        setErrorMessage("Erro ao realizar login com Google.");
    };
                ...
                <div className="w-[57%] bg-[#000002] text-white flex flex-col justify-center p-85">
                    ...
                    <div className="flex items-center justify-center mt-4">
                        <GoogleLogin
                            ...
                            onError={() => setErrorMessage("Erro na autenticação Google")}
                            flow="implicit"
                            type="standard"
                            theme="filled_black"
                            text="signin_with"
