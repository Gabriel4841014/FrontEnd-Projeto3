  ...
  return (
    <div className="bg-black text-[#d6c9b9] min-h-screen flex flex-col items-center px-4 py-8">
      ...
      <section className="w-full max-w-4xl flex flex-col items-center space-y-10">
        ...
        {/* Accordion Section */}
        <div className="bg-black w-full text-white py-10 flex flex-col sm:flex-row justify-between items-start gap-10">
            ...
            <div className="space-y-6 text-sm sm:text-base">
              {[
                ...
                <div key={index} className="border-b border-[#3a3a3a]">
                  ...
                  {openAccordion === index && (
                    <div className="pb-5 text-[#d1d1d1] text-sm">
                      {item.answer}
                    </div>
                  )}
                </div>
          ...
          <div className="flex-1 min-h-125  sm:w-1/2 flex justify-center">
            <img
              src="img_faq.png"
