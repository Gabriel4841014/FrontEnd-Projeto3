...
<div className="bg-black text-[#d6c9b9] min-h-screen flex flex-col items-center px-4 py-8">
 ...
 <section className="w-full max-w-4xl flex flex-col items-center space-y-10">
     ...
     <form
         className="w-full max-w-3xl h-110 bg-[#22272f] rounded-lg p-6 space-y-4"
         action="#"
         method="POST"
     >
         <div className="grid relative mt-3 grid-cols-1 h-10 sm:grid-cols-2 gap-4">
             ...
             <input
                 ...
                 required
             />
             <label className='absolute flex end-67 top-[-1.5rem]'>Sobrenome</label>
             <input
                 type="text"
                 name="sobrenome"
         ...
         <div className="grid grid-cols-1 h-10 sm:grid-cols-2 gap-4">
            <label className='absolute top-[-5px]'>Nome</label>
             <input
                 type="email"
                 name="email"
                 ...
                 required
             />
             <label className='absolute ml-93'>Sobrenome</label>
             <input
                 type="text"
                 name="assunto"
